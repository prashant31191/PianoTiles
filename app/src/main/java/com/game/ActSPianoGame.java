...
public class ActSPianoGame extends TileUtility implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_spiano_game);
    ...
    public void playSoundEffect(int i){
        if (i == 0){
            MediaPlayer sound = MediaPlayer.create(this, R.raw.s63);//piano063
            sound.start();
        }else if (i == 1){
            MediaPlayer sound = MediaPlayer.create(this, R.raw.s38);//piano038
            sound.start();
        }else if (i == 2){
            MediaPlayer sound = MediaPlayer.create(this, R.raw.s45);//piano045
            sound.start();
        }else if (i == 3){
            MediaPlayer sound = MediaPlayer.create(this, R.raw.s53);//piano053
            sound.start();
        }else{
            MediaPlayer sound = MediaPlayer.create(this, R.raw.s31);//low_key
            sound.start();
        }
    }
    ...
    public void onClick(View v) {
        ...
        tvScore.setText("Score : "+programCounter);
