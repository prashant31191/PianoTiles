...
import com.piano.utils.RecordInfo;
import com.piano.utils.RecordInfoUtils;
...
public class ActPlayPiano extends Activity {
    ...
    protected void onStart() {
        ...
        final Context context = ActPlayPiano.this;
        ...
        recordBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRecording) {
                    ...
                    timeTunesMap.clear();
                    recordBtn.setText("Stop recording");//停止录音
                }
            }
        });
            ...
            public void handleMessage(Message msg) {
                if (msg.what == 1) {
                    ...
                    if (msg.obj != null) {
                        ...
                        int tunes = msg.arg1;
                        //btn = (ImageView) findViewById(getResources().getIdentifier("s" + tunes + "_btn", "id", "com.piano"));
                        btn = (ImageView) findViewById(getResources().getIdentifier("s" + tunes + "_btn", "id", "com.czp.pianotiles"));
                    }
                    ...
                    isPlaying = false;
                    playBtn.setText("Play");//播放
                    Toast.makeText(ActPlayPiano.this, "The end of the play", Toast.LENGTH_SHORT).show();//播放结束
                } else if (msg.what == 3) {         // 音调切换
                    int tunesAdd = msg.arg1;
                    //RadioButton tuneRadio = (RadioButton) findViewById(getResources().getIdentifier("t" + tunesAdd + "_btn", "id", "com.piano"));
                    RadioButton tuneRadio = (RadioButton) findViewById(getResources().getIdentifier("t" + tunesAdd + "_btn", "id", "com.czp.pianotiles"));
                    tuneRadio.performClick();
                    Toast.makeText(ActPlayPiano.this, "Tone switch to" + tuneRadio.getText(), Toast.LENGTH_SHORT).show();//音调切换为
                }
            }
        };
        ...
        playBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isPlaying) {
                    ...
                    isPlaying = true;
                    playBtn.setText("Stop play");//停止播放
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRecording) {
                    Toast.makeText(ActPlayPiano.this, "Is recording it, do not worry Oh~", Toast.LENGTH_SHORT).show();//正在录音呢, 别急哦
                    return;
                }
                if (timeTunesMap.isEmpty()) {
                    Toast.makeText(ActPlayPiano.this, "You do not seem to record it, after the completion of the recording and then upload it~", Toast.LENGTH_SHORT).show();//你好像没有录音呢，录音完成后再上传吧
                    return;
                }

                Intent intent = new Intent();
                intent.setClass(ActPlayPiano.this, WebviewActivity.class);
...
//            Toast.makeText(ActPlayPiano.this, timeTunesMap.toString(), Toast.LENGTH_LONG).show();
            final Button playBtn = (Button) this.findViewById(R.id.play_btn);
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    //RadioButton tuneRadio = (RadioButton) findViewById(getResources().getIdentifier("t" + recordTune + "_btn", "id", "com.piano"));
                    RadioButton tuneRadio = (RadioButton) findViewById(getResources().getIdentifier("t" + recordTune + "_btn", "id", "com.czp.pianotiles"));
                    tuneRadio.performClick();
                    Toast.makeText(ActPlayPiano.this, "Has been automatically switched to tone " + tuneRadio.getText() + " Play", Toast.LENGTH_SHORT).show();
                    //Toast.makeText(ActPlayPiano.this, "已自动切换到音调 " + tuneRadio.getText() + " 播放", Toast.LENGTH_SHORT).show();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (lastBackTimestamp == 0 || nowTimeStamp - lastBackTimestamp > 2000) {
                ...
                Toast.makeText(ActPlayPiano.this, "Press again to exit", Toast.LENGTH_SHORT).show();
                return true;
            } else {
